...
# ==========================================
# CONFIGURACIÓN: PLANCHA ROPA
# ==========================================
NOMBRE_APARATO = "Plancha Ropa (Entrenamiento)" 

# Consumo: Muy alto (Resistencia calentando)
WATTS_ENCENDIDO = (1200, 2400)
WATTS_APAGADO = (0, 1)     

# Ciclos 50/50: Sesiones de planchado (30 a 60 min)
