...
# ==========================================
# CONFIGURACIÓN: CALEFACTOR PORTÁTIL
# ==========================================
NOMBRE_APARATO = "Calefactor Portátil (Entrenamiento)" 

# Consumo: Alto consumo al calentar, bajo en ventilación
WATTS_ENCENDIDO = (400, 1500)
WATTS_APAGADO = (0, 4)     

# Ciclos 50/50 (1 a 2 horas cada estado)
MINUTOS_ENCENDIDO = (60, 120)   
MINUTOS_APAGADO = (60, 120)   
