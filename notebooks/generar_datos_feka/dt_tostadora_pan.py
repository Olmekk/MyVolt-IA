...
# ==========================================
# CONFIGURACIÓN: TOSTADOR PAN
# ==========================================
NOMBRE_APARATO = "Tostador Pan (Entrenamiento)" 

# Consumo: Resistencias calientes (600-1600W)
WATTS_ENCENDIDO = (600, 1600)
WATTS_APAGADO = (0, 2)     

# Ciclos 50/50: (10 a 20 min)
