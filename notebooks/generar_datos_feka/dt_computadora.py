...
# ==========================================
# CONFIGURACIÓN: COMPUTADORA ESCRITORIO
# ==========================================
NOMBRE_APARATO = "Computadora (Entrenamiento)" 

# Consumo: Rango amplio (Ofimática suave vs Gaming intenso)
WATTS_ENCENDIDO = (50, 1000)
WATTS_APAGADO = (1, 5)     

# Ciclos 50/50: Sesiones largas (2 a 4 horas de trabajo/juego)
MINUTOS_ENCENDIDO = (120, 240)   
MINUTOS_APAGADO = (120, 240)   
