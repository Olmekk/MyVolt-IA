...
# ==========================================
# CONFIGURACIÓN: SECADORA PELO
# ==========================================
NOMBRE_APARATO = "Secadora Pelo (Entrenamiento)" 

# Consumo: Motor + Resistencia (800-2000W)
WATTS_ENCENDIDO = (800, 2000)
WATTS_APAGADO = (0, 1)     

# Ciclos 50/50: (15 a 30 min)
