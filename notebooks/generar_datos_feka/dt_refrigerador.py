...
# ==========================================
# CONFIGURACIÓN: REFRIGERADOR
# ==========================================
NOMBRE_APARATO = "Refrigerador (Entrenamiento)" 

# Consumo: Compresor activo (150-600W) vs Reposo/Ventilación (5-15W)
WATTS_ENCENDIDO = (150, 600)
WATTS_APAGADO = (5, 15)     

# Ciclos 50/50: El refri prende y apaga todo el día (ciclos de 45-60 min)
MINUTOS_ENCENDIDO = (45, 60)   
MINUTOS_APAGADO = (45, 60)   
