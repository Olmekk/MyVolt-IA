...
# ==========================================
NOMBRE_APARATO = "Laptop (Entrenamiento)" 

# Consumo: Trabajo normal/Carga (30-90W) vs Suspensión/Standby (0.5-3W)
WATTS_ENCENDIDO = (30, 150)
WATTS_APAGADO = (0.5, 3)     

# Ciclos 50/50: Sesiones de trabajo o estudio (1 a 3 horas)
