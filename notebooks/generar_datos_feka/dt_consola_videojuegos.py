...
# ==========================================
# CONFIGURACIÓN: CONSOLA VIDEOJUEGOS
# ==========================================
NOMBRE_APARATO = "Consola Videojuegos (Entrenamiento)" 

# Consumo: Menú/Juegos livianos (50W) hasta AAA pesados (250W)
# Standby: Hasta 15W si está en modo "Inicio Rápido"
WATTS_ENCENDIDO = (50, 250)
WATTS_APAGADO = (0.5, 15)     

# Ciclos 50/50: Sesiones de juego típicas (1 a 3 horas)
MINUTOS_ENCENDIDO = (60, 180)   
MINUTOS_APAGADO = (60, 180)   
